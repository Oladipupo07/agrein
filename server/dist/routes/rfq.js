...
exports.rfqRouter = void 0;
const express_1 = require("express");
exports.rfqRouter = (0, express_1.Router)();
...
exports.rfqRouter.get('/', (req, res) => {
    res.json({ success: true, data: mockRfqs });
});
exports.rfqRouter.post('/', (req, res) => {
...
exports.rfqRouter.post('/:id/bids', (req, res) => {
